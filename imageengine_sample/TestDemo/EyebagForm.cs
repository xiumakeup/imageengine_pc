...
namespace TestDemo
{
    public partial class EyebagForm : Skin_Mac
    {
        public EyebagForm(Bitmap srcBitmap, int[] landmark)
        {
            InitializeComponent();
        ...
        private void skinHScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            mForm.RefreshDisplay(zMakeup.DoEyeBagRemoval(curBitmap, _landMark, warp_ratio));
