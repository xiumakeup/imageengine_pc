...
namespace TestDemo
{
    public partial class DefreckleForm : Skin_Mac
    {
        public DefreckleForm(Bitmap srcBitmap)
        {
            InitializeComponent();
        ...
        private Point frecklePos;
        private void skinButton1_Click(object sender, EventArgs e)
        {

            mForm = (Form1)this.Owner;
            mForm.RefreshDisplay(curBitmap);
        ...
        private void pictureBox1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            {
                frecklePos = new Point(e.X, e.Y);
            }
        }

        private void pictureBox1_MouseUp(object sender, MouseEventArgs e)
        {
            curBitmap = zMakeup.DoDefreckleMenual(curBitmap, frecklePos, radius);
            pictureBox1.Image = (Image)curBitmap;
            pictureBox1.Refresh();
        }
    }
