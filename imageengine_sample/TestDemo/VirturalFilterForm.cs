...
namespace TestDemo
{
    public partial class VirturalFilterForm : Skin_Mac
    {
        public VirturalFilterForm(Bitmap srcBitmap)
        {
            InitializeComponent();
        ...
        private void skinHScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            mForm.RefreshDisplay(zPhoto.VirtualFilterProcess(curBitmap, curBitmap.Width / 2, curBitmap.Height / 2, 15, skinHScrollBar1.Value));
