...
namespace TestDemo
{
    public partial class SkinColorForm : Skin_Mac
    {
        public SkinColorForm(Bitmap srcBitmap)
        {
            InitializeComponent();
        ...
        private void skinHScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            mForm.RefreshDisplay(zMakeup.DoSkinColor(curBitmap, skinHScrollBar1.Value));
            textBox1.Text = (skinHScrollBar1.Value - 50).ToString();
        }
    }
}
