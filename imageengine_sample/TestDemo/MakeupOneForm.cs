...
namespace TestDemo
{
    public partial class MakeupOneForm : Skin_Mac
    {
        public MakeupOneForm(Bitmap srcBitmap, int[] landmark)
        {
            InitializeComponent();
        ...
        private void skinButton1_Click_1(object sender, EventArgs e)
        {
            ...
            mForm.RefreshDisplay(zMakeup.DoMakeupOneKey(curBitmap, _landMark));
