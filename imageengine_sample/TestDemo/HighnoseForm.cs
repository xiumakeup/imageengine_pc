...
namespace TestDemo
{
    public partial class HighnoseForm : Skin_Mac
    {
        public HighnoseForm(Bitmap srcBitmap, int[] landmark)
        {
            InitializeComponent();
        ...
        private void FaceLiftHScrollBar_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            int warp_ratio = FaceLiftHScrollBar.Value;
            mForm.RefreshDisplay(zMakeup.DoHighNose(curBitmap, _landMark, warp_ratio));
