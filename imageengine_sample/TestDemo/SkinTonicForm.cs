...
namespace TestDemo
{
    public partial class SkinTonicForm : Skin_Mac
    {
         public SkinTonicForm(Bitmap srcBitmap, int[] landmark)
        {
            InitializeComponent();
        ...
        private void SkinTonicHScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            mForm = (Form1)this.Owner;
            int tonicRatio = softskinHScrollBar1.Value;

            Color tonicColor = Color.FromArgb(253, 207, 188);
            mForm.RefreshDisplay(zMakeup.DoSkinTonic(curBitmap, _landMark, tonicColor, tonicRatio));
