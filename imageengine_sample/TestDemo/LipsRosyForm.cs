...
namespace TestDemo
{
    public partial class LipsRosyForm : Skin_Mac
    {
        public LipsRosyForm(Bitmap srcBitmap, int[] landmark)
        {
            InitializeComponent();
        ...
        int[] _landMark;
        int[] rosy_color = new int[3] { 255, 0, 0 };
        ...
        private void skinHScrollBar1_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            mForm.RefreshDisplay(zMakeup.DoLipsRosy(curBitmap, _landMark, warp_ratio, rosy_color));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                rosy_color[0] = colorDialog1.Color.R;
                rosy_color[1] = colorDialog1.Color.G;
                rosy_color[2] = colorDialog1.Color.B;
